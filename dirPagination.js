...
(function () { /**
    ...
    function dirPaginateDirective($compile, $parse, paginationService) {
        ...
        return {terminal: true, multiElement: true, priority: 100, compile: dirPaginationCompileFn};
        ...
        function addNgRepeatToElement(element, attrs, repeatExpression) {
            if (element[0].hasAttribute('dir-paginate-start') || element[0].hasAttribute('data-dir-paginate-start')) { // using multiElement mode (dir-paginate-start, dir-paginate-end)
        ...
        function makeCurrentPageGetterFn(scope, attrs, paginationId) {
            ...
            if (attrs.currentPage) {
                ...
                var defaultCurrentPage = '_' + (
                    paginationId + '__currentPage'
                ).replace(/\W/g, '_');
            ...
            function goToPage(num) {
                if (paginationService.isRegistered(paginationId) && isValidPageNumber(num)) {
                    ...
                    if (scope.onPageChange) {
                        scope.onPageChange({newPageNumber: num, oldPageNumber: oldPageNumber});
                    }
                }
            }
    ...
    function itemsPerPageFilter(paginationService) {
        ...
        return function (collection, itemsPerPage, paginationId) {
            ...
            if (angular.isObject(collection)) {
                ...
                if (collection instanceof Array) { // the array just needs to be sliced
